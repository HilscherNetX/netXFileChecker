...
***********************************************************************************************************************
  $Id: Hil_DeviceProductionData.h 242 2019-07-16 14:53:18Z AndreasB $: *//*!

  \file   Hil_DeviceProductionData.h
  \brief  Device Production Data for the netX90 and netX400.

  Structure definition for the Device Production Data for the netX90 and netX400. The structure
  HIL_PRODUCT_DATA_LABEL_T is placed within the internal flash of the netX90 or in the serial flash of the netX4x00,
  please refer https://kb.hilscher.com/x/DzHtBQ for detailed information.
...
typedef __HIL_PACKED_PRE struct __HIL_PACKED_POST HIL_PRODUCT_DATA_FLASH_LAYOUT_AREAS_Ttag
{
  ...
  /*! Area start address.
   * Address in bytes within the chip (ulChipNumber). */
